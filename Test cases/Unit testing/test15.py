...
class Test15(unittest.TestCase):
    ...
    def test_15(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Time'])[1]/following::b[1]").click()
        ...
        Select(driver.find_element_by_id("addJobVacancy_jobTitle")).select_by_visible_text("HR Manager")
        driver.find_element_by_id("addJobVacancy_jobTitle").click()
        driver.find_element_by_id("addJobVacancy_name").click()
        driver.find_element_by_id("addJobVacancy_name").clear()
        driver.find_element_by_id("addJobVacancy_name").send_keys("Manager")
        driver.find_element_by_id("addJobVacancy_hiringManager").click()
        driver.find_element_by_id("addJobVacancy_hiringManager").clear()
        driver.find_element_by_id("addJobVacancy_hiringManager").send_keys("manoj anderson")
