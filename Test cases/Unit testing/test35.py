...
class Test35(unittest.TestCase):
    ...
    def test_35(self):
        ...
        driver.find_element_by_id("menu_admin_viewSkills").click()
        driver.find_element_by_id("btnAdd").click()
        driver.find_element_by_id("skill_name").click()
        driver.find_element_by_id("skill_name").clear()
        driver.find_element_by_id("skill_name").send_keys("Programming")
