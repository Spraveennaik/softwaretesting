...
class Test10(unittest.TestCase):
    ...
    def test_10(self):
        ...
        driver.find_element_by_id("empsearch_employee_name_empName").click()
        # ERROR: Caught exception [ERROR: Unsupported command [doubleClick | id=empsearch_employee_name_empName | ]]
        driver.find_element_by_id("empsearch_employee_name_empName").clear()
        driver.find_element_by_id("empsearch_employee_name_empName").send_keys("Robert")
