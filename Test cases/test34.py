...
class Test34(unittest.TestCase):
    ...
    def test_34(self):
        ...
        driver.find_element_by_id("nationality_name").click()
        driver.find_element_by_id("nationality_name").clear()
        driver.find_element_by_id("nationality_name").send_keys("Disneyland")
