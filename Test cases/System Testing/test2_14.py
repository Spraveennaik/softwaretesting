...
class SystestCase(SystemTest):
	...
	def Main(self):
		driver = self.driver
		el = driver.find_element_by_id('menu__Performance')
		hover(driver, el)

		sub_els = driver.find_elements_by_xpath('/html/body/div[1]/div[2]/ul/li[6]/ul/li')
		sub_tabs_required = ['Configure', 'Manage Reviews', 'Employee Trackers']
		sub_tabs_present = []
