...
class SystestCase(SystemTest):
	...
	def Main(self):
		driver = self.driver
		driver.find_element_by_id('menu_maintenance_purgeEmployee').click()

		sub_els = driver.find_elements_by_xpath('/html/body/div[1]/div[2]/ul/li[9]/ul/li')
		sub_tabs_required = ['Purge Records', 'Access Records']
		sub_tabs_present = []
